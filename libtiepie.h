...
#define LIBTIEPIE_VERSION_MINOR    6
#define LIBTIEPIE_VERSION_RELEASE  7
#define LIBTIEPIE_VERSION_NUMBER   "0.6.7"
#define LIBTIEPIE_VERSION          "0.6.7"
#define LIBTIEPIE_REVISION         11843
...
#define TKM_PULSE            ( TKM_PULSEWIDTH ) //!< All pulse triggers
 ...
 */
#ifdef LIBTIEPIE_DYNAMIC
typedef bool8_t(*LibTiePieDevTrOutTrigger_t)( TpDeviceHandle_t hDevice , uint16_t wOutput );
#else
 ...
 * \param[in] hDevice A \ref OpenDev "device handle" identifying the oscilloscope.
 * \param[in] wCh The channel number identifying the channel, \c 0 to <tt>ScpGetChannelCount() - 1</tt>.
 * \param[in] dwTriggerLevelMode The requested trigger level mode, a \ref TLM_ "TLM_*" value.
 ...
 */
#ifdef LIBTIEPIE_DYNAMIC
typedef double(*LibTiePieScpChTrVerifyTimeEx2_t)( LibTiePieHandle_t hDevice , uint16_t wCh , uint32_t dwIndex , double dTime , uint32_t dwMeasureMode , double dSampleFrequency , uint64_t qwTriggerKind , uint32_t dwTriggerCondition );
#else
double ScpChTrVerifyTimeEx2( LibTiePieHandle_t hDevice , uint16_t wCh , uint32_t dwIndex , double dTime , uint32_t dwMeasureMode , double dSampleFrequency , uint64_t qwTriggerKind , uint32_t dwTriggerCondition );
#endif
 ...
 * \brief XXX
 *
 * \param[in] hServer A \ref XXX "server handle" identifying the server.
 * \param[in] bAsync XXX
 * \return XXX
 * \since 0.6
 */
 ...
 *
 * \param[in] hServer A \ref XXX "server handle" identifying the server.
 * \return XXX, see LIBTIEPIE_SERVER_STATUS
 * \since 0.6
 */
#ifdef LIBTIEPIE_DYNAMIC
 ...
 *
 * \param[in] hServer A \ref XXX "server handle" identifying the server.
 * \return XXX, see LIBTIEPIE_SERVER_ERROR
 * \since 0.6
 */
#ifdef LIBTIEPIE_DYNAMIC
...
/**
 * \brief Get the URL of the specified server.
 *
 * \param[in] hServer A \ref XXX "server handle" identifying the server.
...
/**
 * \brief Get the id of the specified server.
 *
 * \param[in] hServer A \ref XXX "server handle" identifying the server.
...
/**
 * \brief Get the IPv4 address of the specified server.
 *
 * \param[in] hServer A \ref XXX "server handle" identifying the server.
...
/**
 * \brief Get the IP port number of the specified server.
 *
 * \param[in] hServer A \ref XXX "server handle" identifying the server.
...
/**
 * \brief Get the name of the specified server.
 *
 * \param[in] hServer A \ref XXX "server handle" identifying the server.
 * \param[out] pBuffer A pointer to a buffer for the name.
 * \param[in] dwBufferLength The length of the buffer, in bytes.
...
/**
 * \brief Get the description of the specified server.
 *
 * \param[in] hServer A \ref XXX "server handle" identifying the server.
...
/**
 * \brief Get the software version number of the specified server.
 *
 * \param[in] hServer A \ref XXX "server handle" identifying the server.
...
/**
 * \brief Get the software version postfix of the specified server.
 *
 * \param[in] hServer A \ref XXX "server handle" identifying the server.
